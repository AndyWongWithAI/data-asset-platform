const D = {
  ...
  infoItems: [
    { id: 'ii_voltage', code: 'II0001', nameCn: '电压等级编码', nameEn: 'voltage_level_code', termIds: ['term_voltage', 'term_level', 'term_code'], valueDomainId: 'vd_varchar10', refDataId: 'rd_voltage' },
    { id: 'ii_active_power', code: 'II0002', nameCn: '有功功率值', nameEn: 'active_power_value', termIds: ['term_active', 'term_power', 'term_value'], valueDomainId: 'vd_dec52', refDataId: null },
    { id: 'ii_turbine_model', code: 'II0003', nameCn: '风机机型名称', nameEn: 'turbine_model_name', termIds: ['term_turbine', 'term_model', 'term_name'], valueDomainId: 'vd_name', refDataId: 'rd_turbine' },
    { id: 'ii_foundation', code: 'II0004', nameCn: '基础型式名称', nameEn: 'foundation_pattern_name', termIds: ['term_foundation', 'term_pattern', 'term_name'], valueDomainId: 'vd_name', refDataId: 'rd_foundation' },
    { id: 'ii_sea_area', code: 'II0005', nameCn: '海域编码', nameEn: 'sea_area_code', termIds: ['term_sea_area', 'term_code'], valueDomainId: 'vd_code', refDataId: 'rd_sea_area' },
    { id: 'ii_cable_type', code: 'II0006', nameCn: '海缆类型名称', nameEn: 'cable_type_name', termIds: ['term_cable', 'term_type', 'term_name'], valueDomainId: 'vd_name', refDataId: 'rd_cable' },
    { id: 'ii_accuracy', code: 'II0007', nameCn: '预测精度百分比', nameEn: 'forecast_accuracy_percent', termIds: ['term_forecast', 'term_accuracy', 'term_percent'], valueDomainId: 'vd_percent', refDataId: null },
    { id: 'ii_wind_speed', code: 'II0008', nameCn: '风速值', nameEn: 'wind_speed_value', termIds: ['term_wind_speed', 'term_value'], valueDomainId: 'vd_dec52', refDataId: null },
    { id: 'ii_temperature', code: 'II0009', nameCn: '温度值', nameEn: 'temperature_value', termIds: ['term_temperature', 'term_value'], valueDomainId: 'vd_dec51', refDataId: null },
    { id: 'ii_progress', code: 'II0010', nameCn: '进度百分比', nameEn: 'progress_percent', termIds: ['term_progress', 'term_percent'], valueDomainId: 'vd_percent', refDataId: null },
  ],
  qualityRules: [
