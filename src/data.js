const D = {
  ...
  securityCatalog: [
    { id: 'sc_001', category1: '项目经营域', category2: '投标管理', dataType: '投标书', level: 'L2', tableIds: [] },
    { id: 'sc_002', category1: '项目经营域', category2: '合同管理', dataType: '合同', level: 'L3', tableIds: [] },
    { id: 'sc_003', category1: '设计研发域', category2: '资源评估', dataType: '测风数据', level: 'L2', tableIds: ['t_wind'] },
    { id: 'sc_004', category1: '设计研发域', category2: '勘测', dataType: '地质钻孔数据', level: 'L3', tableIds: ['t_geo'] },
    { id: 'sc_005', category1: '设计研发域', category2: '勘测', dataType: '海底地形测绘数据', level: 'L4', tableIds: ['t_topo', 't_cable', 't_substation'] },
    { id: 'sc_006', category1: '设计研发域', category2: '专业设计', dataType: '风机设备数据', level: 'L2', tableIds: ['t_turbine'] },
    { id: 'sc_007', category1: '设计研发域', category2: '专业设计', dataType: '海缆参数数据', level: 'L3', tableIds: ['t_cable'] },
    { id: 'sc_008', category1: '设计研发域', category2: '专业设计', dataType: '升压站主变数据', level: 'L2', tableIds: ['t_substation'] },
    { id: 'sc_009', category1: '工程交付域', category2: '施工管理', dataType: '施工作业进度数据', level: 'L2', tableIds: ['t_progress'] },
    { id: 'sc_010', category1: '工程交付域', category2: '运营管理', dataType: 'SCADA遥测数据', level: 'L2', tableIds: ['t_scada', 't_forecast', 't_spare'] },
    { id: 'sc_011', category1: '工程交付域', category2: '运营管理', dataType: '功率预测结果数据', level: 'L2', tableIds: ['t_forecast'] },
    { id: 'sc_012', category1: '专业技术域', category2: '新能源发电设计', dataType: '发电量测算报告', level: 'L2', tableIds: [] },
    { id: 'sc_013', category1: '支撑服务域', category2: '供应链', dataType: '备品备件数据', level: 'L2', tableIds: ['t_spare'] },
  ],
  masterData: [
